...
//.group, w-full whitespace-nowrap rounded-xl px-4 py-3 text-left text-gray-700 dark:text-gray-300 md:whitespace-normal 
.btn, .relative, .btn-neutral, .flex .flex-col .gap-2{
  background-color: #333333!important;
}
